...
if not user_input:
    st.text("This AI Assistant is not a specialist in any field. It's mainly for general questions. \nFor more help in the desired field, please go to specialized AI Assistants.")
